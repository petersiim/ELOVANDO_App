          ...
          builder: (context, constraints) {
            return Stack(
              children: <Widget>[
                ...
                for (int i = 0; i < _leavesControllers.length; i++)
                  Positioned(
                    top: constraints.maxHeight *
                        (0.05 +
                            i * 0.1), // Different positions for different sets of leaves
                    left: 0,
                    right: 0,
                    child: AnimatedBuilder(
                      ...
                      builder: (context, child) {
                        return Transform.translate(
                          offset:
                              _leavesAnimations[i].value * constraints.maxWidth,
                          child: Transform(
                ...
                Positioned(
                  top: constraints.maxHeight *
                      0.31, // Adjust the top position as needed
                  left: 0,
                  right: 0,
                  child: AnimatedOpacity(
                    ...
                    child: SvgPicture.asset(
                      ...
                      width:
                          constraints.maxWidth * 0.4, // Adjust size as needed
                      height:
                          constraints.maxHeight * 0.15, // Adjust size as needed
                    ),
                  ),
                ),
                  ...
                  child: Container(
                    decoration: BoxDecoration(
                      gradient: LinearGradient(
                        ...
                        colors: [
                          Color(0xFF22577A)
                              .withOpacity(0.2), // Top color with 20% opacity
                          Color(0xFFF9AC36).withOpacity(
                              0.2), // Bottom color with 20% opacity
                        ],
                        stops: [0.0, 1.0],
                      ),
                    ),
                        ...
                        ClipRRect(
                          ...
                          child: BackdropFilter(
                            filter: ImageFilter.blur(
                                sigmaX: 5,
                                sigmaY: 5), // Apply background blur
                            child: Container(
                              padding: EdgeInsets.fromLTRB(24.0, 40.0, 24.0,
                                  70.0), // Add padding: left, top, right, bottom
                              decoration: BoxDecoration(
                                color: Colors.white.withOpacity(
                                    0.55), // Slightly transparent white fill with 55% opacity
                                border: Border.all(
                                  color: Colors.white.withOpacity(
                                      0.3), // Border with 30% opacity
